    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //Adapted from Q&A video 'MPC Controller'
          ...
          */
          ...
          auto vars = mpc.Solve(state, coeffs, Lf);

          // the waypoints/reference line
          ...
          // get the values from the mpc.Solve() result
